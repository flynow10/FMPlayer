...
This package has been copied and modified to work in browsers by removing the use of the node:Buffer class
The original package can be found [here on github](https://github.com/sindresorhus/file-type) or [here on npm](https://www.npmjs.com/package/file-type)
